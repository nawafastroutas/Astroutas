...
- `assets/brand/subbha-icon-source.jpg` — شعار سبحة الرسمي (النسخة المربعة
  الجاهزة لأيقونة التطبيق)، مُصدَّر بأحجام PNG متعددة (16/32/180/192/512)
  في `assets/icons/` لجميع الاستخدامات (Favicon، Apple Touch Icon، أيقونات
  المتصفح/الهاتف).
