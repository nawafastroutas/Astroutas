...
- الألوان كلها متغيّرات CSS أعلى `src/splash/splash.css` (مطابقة لهوية
  سبحة: بني/ذهبي/كريمي) — غيّرها من مكان واحد فقط.
...
- `assets/icons/tasbih-icon.svg` — أيقونة سبحة (تصميم أصلي: حلقة خرز +
  خرزة الإمام + شرّابة) بألوان الهوية، مُصدَّرة بأحجام PNG متعددة
  (16/32/180/192/512) لجميع الاستخدامات (Favicon، Apple Touch Icon،
  أيقونات المتصفح/الهاتف).
