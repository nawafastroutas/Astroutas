        ...
        <div className="entrance__mark">
          ...
          <svg className="entrance__logo" viewBox="0 0 120 120" role="img"
            ...
            <g fill="none" strokeLinecap="round">
              <path className="ent-logo-arc" d="M72 20C4 42 4 78 72 100" stroke="var(--logo-plum)"
                    strokeWidth="6.5" pathLength="100" style={{ '--draw-delay': '840ms' }} />
              <path className="ent-logo-arc" d="M48 20C116 42 116 78 48 100" stroke="var(--logo-plum)"
                    strokeWidth="6.5" pathLength="100" style={{ '--draw-delay': '920ms' }} />
              <path className="ent-logo-arc" d="M66 26C24 46 24 74 66 94" stroke="var(--logo-teal)"
                    strokeWidth="5.5" pathLength="100" style={{ '--draw-delay': '1000ms' }} />
              <path className="ent-logo-arc" d="M54 26C96 46 96 74 54 94" stroke="var(--logo-teal)"
